    ...
    */
    ...
    function form($instance) {
        ...
        <label for="<?php echo $this->get_field_id('pin_user'); ?>">
            <p><?php _e('Pinterest account', 'gv_pinfeed'); ?>: <input style="width: 100%;" type="text"
                value="<?php echo $instance['pin_user']; ?>" name="<?php echo $this->get_field_name('pin_user'); ?>"
                id="<?php echo $this->get_field_id('pin_user'); ?>"></p>
        </label>

        <label for="<?php echo $this->get_field_id('pin_board'); ?>">
            <p><?php _e('Board', 'gv_pinfeed'); ?>: <input style="width: 100%;" type="text"
                value="<?php echo $instance['pin_board']; ?>" name="<?php echo $this->get_field_name('pin_board'); ?>"
                id="<?php echo $this->get_field_id('pin_board'); ?>"></p>
        </label>

        <label for="<?php echo $this->get_field_id('pin_count'); ?>">
            <p><?php _e('# of pins', 'gv_pinfeed'); ?>: <input style="width: 40px" type="text"
                value="<?php echo $instance['pin_count']; ?>" name="<?php echo $this->get_field_name('pin_count'); ?>"
                id="<?php echo $this->get_field_id('pin_count'); ?>"></p>
        </label>

        <label for="<?php echo $this->get_field_id('pin_style'); ?>">
            <p><?php _e('Pinterest style', 'gv_pinfeed'); ?>: <input style="width: 100%;" type="checkbox"
                value="yes" <?php if ($instance['pin_style'] == "yes") {
                    echo "checked='checked'";
                } ?> name="<?php echo $this->get_field_name('pin_style'); ?>"
                id="<?php echo $this->get_field_id('pin_style'); ?>"></p>
        </label>

        <label for="<?php echo $this->get_field_id('pin_slider'); ?>">
            <p><?php _e('Slider', 'gv_pinfeed'); ?>: <input style="width: 100%;" type="checkbox"
                value="yes" <?php if ($instance['pin_slider'] == "yes") {
                    echo "checked='checked'";
                } ?> name="<?php echo $this->get_field_name('pin_slider'); ?>"
                id="<?php echo $this->get_field_id('pin_slider'); ?>"></p>
        </label>
